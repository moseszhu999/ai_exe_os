...
test('S3 service extends the accepted S2 chain and initializes on canonical SQLite before all IPC groups and BrowserWindow', () => {
  ...
  assert.match(main, /S3ApplicationService: S1ApplicationService/);
